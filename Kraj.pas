...
type
  TfrmKraj = class(TForm)
    ...
    procedure cbklasaClick(Sender: TObject);
    procedure cburbrojClick(Sender: TObject);
    procedure cbvladanjeClick(Sender: TObject);
    procedure cbkojiputClick(Sender: TObject);
...
procedure TfrmKraj.cbHrvClick(Sender: TObject);
begin
...
procedure TfrmKraj.cb1JezikClick(Sender: TObject);
begin
...
procedure TfrmKraj.cb2JezikClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbLatClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbGrcClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbGlzClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbLikClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbPsiClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbLogClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbFilClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbSocClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbPovClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbZemClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbMatClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbFizClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbKemClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbBioClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbInfClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbPiGClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbTZKClick(Sender: TObject);
begin
...
procedure TfrmKraj.cbDod1Click(Sender: TObject);
begin
...
procedure TfrmKraj.cbDod2Click(Sender: TObject);
begin
...
procedure TfrmKraj.cbDod3Click(Sender: TObject);
begin
...
procedure TfrmKraj.cbIzb1Click(Sender: TObject);
begin
...
procedure TfrmKraj.cbIzb2Click(Sender: TObject);
begin
...
procedure TfrmKraj.cbFak1Click(Sender: TObject);
begin
...
procedure TfrmKraj.cbFak2Click(Sender: TObject);
begin
...
procedure TfrmKraj.cbDatumClick(Sender: TObject);
begin
...
procedure TfrmKraj.btTraziClick(Sender: TObject);
begin
cbRazred.Clear;
lbkontrola.Clear;
lbrezultati.Clear;
...
if edimeizb1.enabled=true  then edImeIzb1.Text:='';
 ...
 if edkojiput.enabled=true  then edkojiput.Text:='';
 if edvladanje.enabled=true  then edvladanje.Text:='';
 if edurbroj.enabled=true  then edurbroj.Text:='';
 if edklasa.enabled=true  then edklasa.Text:='';
...
procedure TfrmKraj.lbRezultatiClick(Sender: TObject);
begin
...
frmglavna.podaci.Close;
frmglavna.podaci.CommandText:='select * from Kraj where ID='+trazeni;
frmglavna.podaci.ExecuteOptions;
frmglavna.podaci.Open;
trenutni:=trazeni;
...
nesto:=frmglavna.podaci.Recordset.fields.item['kojiput']; nnesto:=nesto; if edkojiput.enabled=true  then edkojiput.Text:=nnesto;
nesto:=frmglavna.podaci.Recordset.fields.item['vladanje']; nnesto:=nesto; if edvladanje.enabled=true  then edvladanje.Text:=nnesto;
nesto:=frmglavna.podaci.Recordset.fields.item['klasa']; nnesto:=nesto;
if edklasa.enabled=true then begin
  if nnesto='' then begin
    ...
    frmglavna.podaci3.close;
  end else edklasa.Text:=nnesto;
end;
nesto:=frmglavna.podaci.Recordset.fields.item['urbroj']; nnesto:=nesto;
if edurbroj.enabled=true then begin
  if nnesto='' then begin
    frmglavna.podaci3.Close;
    frmglavna.podaci3.CommandText:='select * from Postavke';
    frmglavna.podaci3.ExecuteOptions;
...
procedure TfrmKraj.btOdustaniClick(Sender: TObject);
begin
...
procedure TfrmKraj.FormActivate(Sender: TObject);
begin
frmGlavna.Caption:='Registar - Unos ocjena na kraju godine';
cbRazred.Clear;
lbkontrola.Clear;
lbrezultati.Clear;
gbucenik.caption:='Uèenik';
...
procedure TfrmKraj.btSpremiClick(Sender: TObject);
var ponavlja,km,ka,kb,kc:boolean;
label nejde;
begin
km:=false;
...
if (edkojiput.Text<>'1') and (edkojiput.Text<>'2') then kc:=true;
ka:=false;
...
if kc=true then begin application.MessageBox('Potrebno je ispravno napisati put polaska (1/2)...', 'Registar - spremanje ocjena', mb_OK); goto nejde; end;

ponavlja:=false;
if edHrv.Text='1' then ponavlja:=true;
if ed1Jezik.Text='1' then ponavlja:=true;
if ed2Jezik.Text='1' then ponavlja:=true;
if edlat.Text='1' then ponavlja:=true;
if edgrc.Text='1' then ponavlja:=true;
if edglz.Text='1' then ponavlja:=true;
if edlik.Text='1' then ponavlja:=true;
if edpsi.Text='1' then ponavlja:=true;
if edlog.Text='1' then ponavlja:=true;
if edfil.Text='1' then ponavlja:=true;
if edsoc.Text='1' then ponavlja:=true;
if edpov.Text='1' then ponavlja:=true;
if edzem.Text='1' then ponavlja:=true;
if edmat.Text='1' then ponavlja:=true;
if edfiz.Text='1' then ponavlja:=true;
if edkem.Text='1' then ponavlja:=true;
if edbio.Text='1' then ponavlja:=true;
if edinf.Text='1' then ponavlja:=true;
if edpig.Text='1' then ponavlja:=true;
if edtzk.Text='1' then ponavlja:=true;
if eddod1.Text='1' then ponavlja:=true;
if eddod2.Text='1' then ponavlja:=true;
if eddod3.Text='1' then ponavlja:=true;
if edizb1.Text='1' then ponavlja:=true;
if edizb2.Text='1' then ponavlja:=true;
if edfak1.Text='1' then ponavlja:=true;
if edfak2.Text='1' then ponavlja:=true;
if ponavlja=false then begin
  frmglavna.podaci.Close;
  frmglavna.podaci.CommandText:='select * from ponavljaci where broj='+chr(39)+trazeni+chr(39);
  frmglavna.podaci.ExecuteOptions;
  frmglavna.podaci.open;
  if frmglavna.podaci.Recordset.RecordCount>0 then begin
    frmglavna.podaci.Close;
    frmglavna.Baza.Open;
    frmglavna.Baza.Execute('delete from ponavljaci where broj='+chr(39)+trazeni+chr(39));
    frmglavna.Baza.close;
  end;
  frmglavna.podaci.Close;
end;
if ponavlja=true then begin
  frmglavna.podaci.Close;
  frmglavna.podaci.CommandText:='select * from ucenici where id='+trazeni;
  frmglavna.podaci.ExecuteOptions;
  frmglavna.podaci.open;
  ...
  frmglavna.baza.open;
  frmglavna.Baza.Execute('insert into ponavljaci(broj,razred) values('+chr(39)+trazeni+chr(39)+','+chr(39)+nnesto+chr(39)+')');
  frmglavna.Baza.Close;
end;
...
'KojiPut='+chr(39)+edkojiput.text+chr(39)+','+
'vladanje='+chr(39)+edvladanje.text+chr(39)+','+
...
frmglavna.Baza.Execute('update Kraj set '+umetanje+' where ID='+edBroj.Text);
frmglavna.Baza.Close;
...
procedure TfrmKraj.cbklasaClick(Sender: TObject);
begin
if cbklasa.Checked=true then lblklasa.Enabled:=false else lblklasa.Enabled:=true;
if cbklasa.Checked=true then edklasa.Enabled:=false else edklasa.Enabled:=true;
end;

procedure TfrmKraj.cburbrojClick(Sender: TObject);
begin
if cburbroj.Checked=true then lblurbroj.Enabled:=false else lblurbroj.Enabled:=true;
if cburbroj.Checked=true then edurbroj.Enabled:=false else edurbroj.Enabled:=true;
end;

procedure TfrmKraj.cbvladanjeClick(Sender: TObject);
begin
if cbvladanje.Checked=true then lblvladanje.Enabled:=false else lblvladanje.Enabled:=true;
if cbvladanje.Checked=true then edvladanje.Enabled:=false else edvladanje.Enabled:=true;
end;

procedure TfrmKraj.cbkojiputClick(Sender: TObject);
begin
if cbkojiput.Checked=true then edkojiput.Enabled:=false else edkojiput.Enabled:=true;
if cbkojiput.Checked=true then lblkojiput.Enabled:=false else lblkojiput.Enabled:=true;
end;


procedure TfrmKraj.edHrvkeypress(Sender: TObject; var Key: Char);
begin
...
procedure TfrmKraj.edFak1keypress(Sender: TObject; var Key: Char);
begin
